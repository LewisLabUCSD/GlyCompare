...
set(Qt5VirtualKeyboard_VERSION_STRING 5.12.5)
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/qt/QtVirtualKeyboard/5.12.5"
        "${_qt5VirtualKeyboard_install_prefix}/include/qt/QtVirtualKeyboard/5.12.5/QtVirtualKeyboard"
    )
    ...
    foreach(_module_dep ${_Qt5VirtualKeyboard_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5VirtualKeyboard_FIND_VERSION_EXACT}
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "libQt5VirtualKeyboard.5.12.5.dylib" "" )
