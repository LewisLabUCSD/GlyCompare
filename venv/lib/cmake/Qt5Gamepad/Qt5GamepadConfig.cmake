...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/include/qt/QtGamepad/5.12.5"
        "${_qt5Gamepad_install_prefix}/include/qt/QtGamepad/5.12.5/QtGamepad"
    )
    ...
    _populate_Gamepad_target_properties(RELEASE "libQt5Gamepad.5.12.5.dylib" "" )
