...
set(Qt5Purchasing_VERSION_STRING 5.12.5)
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/include/qt/QtPurchasing/5.12.5"
        "${_qt5Purchasing_install_prefix}/include/qt/QtPurchasing/5.12.5/QtPurchasing"
    )
    ...
    foreach(_module_dep ${_Qt5Purchasing_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5Purchasing_FIND_VERSION_EXACT}
    ...
    _populate_Purchasing_target_properties(RELEASE "libQt5Purchasing.5.12.5.dylib" "" )
