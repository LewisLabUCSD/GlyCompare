...
set(Qt5NetworkAuth_VERSION_STRING 5.12.5)
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/qt/QtNetworkAuth/5.12.5"
        "${_qt5NetworkAuth_install_prefix}/include/qt/QtNetworkAuth/5.12.5/QtNetworkAuth"
    )
    ...
    foreach(_module_dep ${_Qt5NetworkAuth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5NetworkAuth_FIND_VERSION_EXACT}
    ...
    _populate_NetworkAuth_target_properties(RELEASE "libQt5NetworkAuth.5.12.5.dylib" "" )
