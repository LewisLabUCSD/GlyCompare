...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES networkinterface;bearermanagement;dnslookup;ftp;http;localserver;networkdiskcache;networkproxy;socks5;ssl;udpsocket)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES dtls;opensslv11;sctp)
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.5.12.5.dylib" "" )
