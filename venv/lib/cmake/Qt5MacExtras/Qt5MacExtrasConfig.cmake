...
set(Qt5MacExtras_VERSION_STRING 5.12.5)
...
if (NOT TARGET Qt5::MacExtras)
    ...
    set(Qt5MacExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5MacExtras_install_prefix}/include/qt/QtMacExtras/5.12.5"
        "${_qt5MacExtras_install_prefix}/include/qt/QtMacExtras/5.12.5/QtMacExtras"
    )
    ...
    foreach(_module_dep ${_Qt5MacExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5MacExtras_FIND_VERSION_EXACT}
    ...
    _populate_MacExtras_target_properties(RELEASE "libQt5MacExtras.5.12.5.dylib" "" )
