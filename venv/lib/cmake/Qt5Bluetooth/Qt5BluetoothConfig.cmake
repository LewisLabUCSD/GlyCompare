...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.12.5"
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.12.5/QtBluetooth"
    )
    ...
    _populate_Bluetooth_target_properties(RELEASE "libQt5Bluetooth.5.12.5.dylib" "" )
