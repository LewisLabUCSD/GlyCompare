...
# Occurance based
def hier_enrich_glycoprofile_occurence(glycoprofile,scoredMotifs_occurence_vector,motif_hierarchy,motif_vector,method='hypergeometric'):
