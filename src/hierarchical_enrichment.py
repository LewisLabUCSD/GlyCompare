...
def hier_enrich_glycoprofile_occurence(glycoprofile, scoredMotifs_occurence_vector, motif_hierarchy, motif_vector,
    ...
    for motif in motif_vector:
        ...
        for child in children:
            whiteMarbles_Urn = scoredMotifs_occurence_vector[
                child]  #### assumes that the index in the hierarchy matches the motif index in the occurance vector
...
def enrich_glycoprofile(glycoprofiles, condition, scoredMotifs_abundance_matrix, motif_hierarchy, motif_vector,
